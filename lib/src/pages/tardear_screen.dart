...
import 'package:seemur/src/pages/cafes_screen.dart';
import 'package:seemur/src/pages/cervecerias_screen.dart';
                                              ...
                                              child: Center(
                                                child: Wrap(
                                                  children: <Widget>[
                                                    FlatButton(
                                                      child: Image.asset(
                                                        'assets/images/icons/coffeeIcon@3x.png',
                                                        width: 38,
                                                        height: 38,
                                                      ),
                                                      onPressed: () {
                                                ...
                                                child: Wrap(
                                                  children: <Widget>[
                                                    SizedBox(
                                                      ...
                                                      child: FlatButton(
                                                        child: Image.asset(
                                                          'assets/images/icons/icreamIcon@3x.png',
                                                          width: 38,
                                                          height: 38,
                                                        ),
                                                        onPressed: () {
                                                ...
                                                child: Wrap(
                                                  children: <Widget>[
                                                    SizedBox(
                                                      ...
                                                      child: FlatButton(
                                                        child: Image.asset(
                                                          'assets/images/icons/beerIcon@3x.png',
                                                          width: 38,
                                                          height: 38,
                                                        ),
                                                        onPressed: () {
